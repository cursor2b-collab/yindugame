...
export default function RegisterPage() {
  ...
  useEffect(() => {
    refreshCaptcha();
    const lang = localStorage.getItem('ly_lang') || 'en';
        ...
        <form onSubmit={handleRegister}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <div style={{
              ...
              paddingRight: '16px',
              background: 'rgba(255, 255, 255, 0.05)',
              border: focusedInput === 'confirmPass' 
                ? '2px solid #ffc53e' 
                : '1px solid rgba(255, 255, 255, 0.1)',
              borderRadius: '12px',
              transition: 'all 0.3s ease',
              boxShadow: focusedInput === 'confirmPass' 
                ? '0 0 0 4px rgba(255, 197, 62, 0.1), 0 4px 12px rgba(0, 0, 0, 0.3)' 
                : '0 2px 8px rgba(0, 0, 0, 0.2)'
            }}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="rgba(255, 197, 62, 0.7)" strokeWidth="2" style={{ marginRight: '12px', flexShrink: 0 }}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <div style={{
              ...
              paddingRight: '16px',
              background: 'rgba(255, 255, 255, 0.05)',
              border: focusedInput === 'paypassword' 
                ? '2px solid #ffc53e' 
                : '1px solid rgba(255, 255, 255, 0.1)',
              borderRadius: '12px',
              transition: 'all 0.3s ease',
              boxShadow: focusedInput === 'paypassword' 
                ? '0 0 0 4px rgba(255, 197, 62, 0.1), 0 4px 12px rgba(0, 0, 0, 0.3)' 
                : '0 2px 8px rgba(0, 0, 0, 0.2)'
            }}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="rgba(255, 197, 62, 0.7)" strokeWidth="2" style={{ marginRight: '12px', flexShrink: 0 }}>
          ...
          <div style={{ marginBottom: '16px' }}>
            <div style={{
              ...
              paddingRight: '16px',
              background: 'rgba(255, 255, 255, 0.05)',
              border: focusedInput === 'inviteCode' 
                ? '2px solid #ffc53e' 
                : '1px solid rgba(255, 255, 255, 0.1)',
              borderRadius: '12px',
              transition: 'all 0.3s ease',
              boxShadow: focusedInput === 'inviteCode' 
                ? '0 0 0 4px rgba(255, 197, 62, 0.1), 0 4px 12px rgba(0, 0, 0, 0.3)' 
                : '0 2px 8px rgba(0, 0, 0, 0.2)'
            }}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="rgba(255, 197, 62, 0.7)" strokeWidth="2" style={{ marginRight: '12px', flexShrink: 0 }}>
